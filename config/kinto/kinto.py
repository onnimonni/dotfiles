...
define_keymap(None,{
    # Change tabs and programs like in Mac
    K("Super-Tab"): K("Ctrl-Tab"),
    K("Super-Shift-Tab"): K("Ctrl-Shift-Tab"),
    K("Ctrl-Tab"): K("Super-Tab"),
    K("Ctrl-Shift-Tab"): K("Super-Shift-Tab"),
    K("Ctrl-Space"): K("Super-a"),
    # Switch between windows of current application (PopOS)
    K("Alt-Tab"): K("M-Grave"),
    K("Alt-Shift-Tab"): K("M-Shift-Grave"),

    # Select word to left/right
    K("Alt-Left"): K("Ctrl-left"),
    K("Alt-Right"): K("Ctrl-Right"),
    K("Alt-Shift-Left"): K("Ctrl-Shift-left"),
    K("Alt-Shift-Right"): K("Ctrl-Shift-Right"),
...
define_keymap(re.compile(termStr, re.IGNORECASE),{
    ...
    # Better copy paste
    K("LC-v"): K("Ctrl-Shift-v"),
    K("LC-k"): K("Ctrl-Shift-v"),
    K("LC-j"): K("Ctrl-Shift-c"),
    K("LC-c"): K("Ctrl-Shift-c"),
    K("LC-f"): K("Ctrl-Shift-f"),
    K("Super-c"): K("Ctrl-c"),
    K("Super-j"): K("Ctrl-c"),
    K("Super-t"): K("Ctrl-k"), # Old habit to press the qwerty K letter to remove a line in Nano
    K("Super-q"): K("Ctrl-x"), # Old habit to press the qwerty X letter to exit in Nano
    K("LC-w"): K("Ctrl-Shift-w"), # Close a tab
    K("LC-n"): K("Ctrl-Shift-n"), # New window
    K("LC-t"): K("Ctrl-Shift-t"), # New window
